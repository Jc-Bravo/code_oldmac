...
def demo_display_specific_digit_combination(images, labels):
    ...
    digit_5 = digit_image_dict[5]
    digit_6 = digit_image_dict[6]
    digit_7 = digit_image_dict[7]
    digit_8 = digit_image_dict[8]
    digit_9 = digit_image_dict[9]
    target_img = torch.cat((digit_2, digit_0, digit_1, digit_9, digit_0, digit_1, digit_1, digit_3, digit_2, digit_5), 2)
