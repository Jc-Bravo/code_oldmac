...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        ...
        response = self.client.get(reverse('deeplearning:index'))
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, "No deeplearning are available,")
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        url = reverse('deeplearning:detail', args=(future_question.id,))
    ...
    def test_past_question(self):
        ...
        url = reverse('deeplearning:detail', args=(past_question.id,))
        response = self.client.get(url)
